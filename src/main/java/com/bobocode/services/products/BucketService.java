...
public final class BucketService {
    ...
    public void addProductToBucket(
        ...
        customJdbcTemplate.execute(sql, bucketId, productId, amount);
    }
    ...
    public void removeProductFromBucket(
        ...
        customJdbcTemplate.execute(sql, bucketId, productId);
    }
    ...
    private Long getOrCreateBucketId(final long userId) {
        ...
        customJdbcTemplate.execute(insertSql, userId);
    ...
    public void clearBucket(final long userId) {
        ...
        if (bucketId != null) {
            ...
            customJdbcTemplate.execute(sql, bucketId);
        }
    }
}
