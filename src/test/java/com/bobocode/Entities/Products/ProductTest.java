...
class ProductTest {
    ...
    void testAllArgsConstructor() {
        // Arrange & Act
        Product product = new Product(100L, "Test Product", BigDecimal.valueOf(50.50), 1L, 10);
        ...
        assertEquals(1L, product.getCategoryId(), "Category ID should match constructor argument");
        assertEquals(10, product.getQuantity(), "Quantity should match constructor argument");
    }
    ...
    void testNoArgsConstructorAndSetters() {
        ...
        assertEquals(5L, product.getCategoryId(), "Category ID should be updated via setter");
        assertEquals(2, product.getQuantity(), "Quantity should be updated via setter");
    }
}